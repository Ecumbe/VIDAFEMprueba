...
function postEvolutionApiJson_(payload) {
    if (typeof postClinicalApiJson_ === "function") {
        return postClinicalApiJson_(payload);
    }
...
window.loadEvolutionModule = function() {
    ...
    const requestPromise = (typeof postClinicalApiJson_ === "function")
